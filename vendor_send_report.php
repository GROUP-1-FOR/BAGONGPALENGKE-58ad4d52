...
<body>
    ...
    <form action="vendor_send_report_1.php" method="post" onsubmit="return validateForm()">
        <label for="vendor_report_ticket">Ticket No: </label>
        <input type="text" id="vendor_report_ticket" name="vendor_report_ticket" value="<?php echo $formattedTicketNumber; ?>" required readonly><br />

        <label for="vendor_report_message">Report Message</label>
        <textarea name="vendor_report_message" id="vendor_report_message" cols="30" rows="5" required maxlength="500" oninput="updateCounter('vendor_report_message', 'message_counter', 500)"></textarea>
