...
<head>
    ...
    <script>
        function validateForm() {
            var reportMessage = document.getElementById("vendor_report_message").value;
...
<body>
    ...
    <form action="vendor_send_report_1.php" method="post" onsubmit="return validateForm()">
        ...
        <textarea name="vendor_report_message" id="vendor_report_message" cols="30" rows="5" required></textarea><br>
