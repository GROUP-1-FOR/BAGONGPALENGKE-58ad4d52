    ...
    <div align="center">
        <div>
            <form action="" method="post">
                <input class="otp-box" type="text" maxlength="6" id="token" name="vendor_token" title="Please enter six characters" placeholder="Enter Token" required oninput="validateInput()">
            ...
            <div>
                <form action="" method="post" id="resendTokenForm">
                    <button class="resend-button" type="submit" id="resendTokenButton" name="vendor_resend_token" disabled>Resend Token</button>
        ...
        <a href=vendor_forgot_password.php>
            <h1>Back</h1>
        </a>
    </div>
</body>
